...
/**
 ...
 Use the `sharedInstance` class method to access the singleton for this class.
 Configure ServiceCloudKit using the `serviceConfiguration` property. 
 Customize the appearance of the interface using the `appearanceConfiguration` property.
 See the other properties in this class for additional functionality.
 */
...
/**
 ...
 @param completion Completion block invoked when the account information has been validated.
 */
...
@interface SCServiceCloud (SCSNotifications)
 ...
 * Use `showInterfaceForNotification:` to show the view associated with this notification.
 *
 ...
 * Use `notificationFromRemoteNotificationDictionary:` to convert an `NSDictionary` into an
 * `SCSNotification` object.
 *
