...
/**
 ...
 Pass an instance of this class to the `[serviceConfiguration]([SCServiceCloud serviceConfiguration])` property on 
 the `SCServiceCloud` shared instance to set the configuration.
 */
