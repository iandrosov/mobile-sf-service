...
/**
 ...
 @warning If you instantiate this view controller and display it manually, you'll also need to display
 <SCSCaseDetailViewController>. When a user selects a case from the case list, present
 your Case Detail view controller from the `caseList:selectedCaseWithId:`
 method in your <SCSCaseListViewControllerDelegate> implementation. If you don't do this, nothing will
 happen when a user taps on a specific case in the case list!
 */
