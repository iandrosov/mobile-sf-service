...
/**
 *  This method determines whether this view controller will handle a connection request prompt. [Default `YES`]
 ...
 *
 *  The SOS backend will wait until it receives an appropriate response. Your UI element must trigger either: <br>
 *  <[SOSOnboardingBaseViewController handleStartSession:]> or<br>
 *  <[SOSOnboardingBaseViewController handleCancel:]> <br>
 *
