...
/**
 ...
 Use the <isArticleContentDownloaded> property to check whether 
 it is downloaded. You can download the article with the
 <downloadContentWithOptions:completion:> method.
 */
...
/**
 ...
 @param options Cache options defining exactly what content to download. See <SCSArticleDownloadOption>.
 @param completionBlock The block to execute after download completes. You may specify `nil` for this parameter.
