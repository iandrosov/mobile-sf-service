 ...
 *  @param current  The new <SCSChatSessionState> which has been set on the for the Live Agent Chat session.
 ...
 *  @param error  NSError instance describing the error. Error codes can be referenced from <SCSChatErrorCode>
 */
